...
export type EnumJobTypeNullableFilter<$PrismaModel = never> = {
  equals?:
    | $Enums.JobType
    | Prisma.EnumJobTypeFieldRefInput<$PrismaModel>
    | null;
  in?:
    | $Enums.JobType[]
    | Prisma.ListEnumJobTypeFieldRefInput<$PrismaModel>
    | null;
  notIn?:
    | $Enums.JobType[]
    | Prisma.ListEnumJobTypeFieldRefInput<$PrismaModel>
    | null;
  not?:
    | Prisma.NestedEnumJobTypeNullableFilter<$PrismaModel>
    | $Enums.JobType
    | null;
};
...
export type EnumCareerLevelNullableFilter<$PrismaModel = never> = {
  equals?:
    | $Enums.CareerLevel
    | Prisma.EnumCareerLevelFieldRefInput<$PrismaModel>
    | null;
  in?:
    | $Enums.CareerLevel[]
    | Prisma.ListEnumCareerLevelFieldRefInput<$PrismaModel>
    | null;
  notIn?:
    | $Enums.CareerLevel[]
    | Prisma.ListEnumCareerLevelFieldRefInput<$PrismaModel>
    | null;
  not?:
    | Prisma.NestedEnumCareerLevelNullableFilter<$PrismaModel>
    | $Enums.CareerLevel
    | null;
};
...
export type EnumJobTypeNullableWithAggregatesFilter<$PrismaModel = never> = {
  ...
  notIn?:
    ...
    | null;
  not?:
    | Prisma.NestedEnumJobTypeNullableWithAggregatesFilter<$PrismaModel>
    | $Enums.JobType
    | null;
  _count?: Prisma.NestedIntNullableFilter<$PrismaModel>;
...
export type EnumCareerLevelNullableWithAggregatesFilter<$PrismaModel = never> =
  {
    ...
    notIn?:
      ...
      | null;
    not?:
      | Prisma.NestedEnumCareerLevelNullableWithAggregatesFilter<$PrismaModel>
      | $Enums.CareerLevel
      | null;
    _count?: Prisma.NestedIntNullableFilter<$PrismaModel>;
